...
**Have mentioned some of the points learnt in these sessions**
**1. To keep the complexity less, to ease unit tests**
**2. no duplications, and keep a common function instead of similar functions**
**3. Identify test case before fixing bug in code**
**4. aim for minimum code to achieve requirements**
